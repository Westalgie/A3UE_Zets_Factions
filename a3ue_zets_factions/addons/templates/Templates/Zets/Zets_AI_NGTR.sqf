...
["name", localize "STR_Zets_NGTR_name"] call _fnc_saveToTemplate;
["spawnMarkerName", format [localize "STR_supportcorridor", localize "STR_Zets_NGTR_name"]] call _fnc_saveToTemplate;
