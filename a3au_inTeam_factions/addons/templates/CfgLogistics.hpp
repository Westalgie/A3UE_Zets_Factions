...
class DOUBLES(ADDON,Nodes) {
    ...
    #include "Logistics\InTeamNodes.hpp" //include the nodes from the different mods here
};

class DOUBLES(ADDON,Cargo) {
    class TRIPLES(ADDON,Cargo,Base); //import base class from antistasi
    #include "Logistics\InTeamCargo.hpp" //include the cargo from the different mods here
};
